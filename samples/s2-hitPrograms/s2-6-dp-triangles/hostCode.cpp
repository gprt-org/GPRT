...
extern GPRTProgram s2_6_deviceCode;
...
uint3 indices[NUM_INDICES] = {{0, 1, 2}, {3, 4, 5}};
...
int main(int ac, char **av) {
  ...
  gprtRequestWindow(fbSize.x, fbSize.y, "S06 Single Triangle");

  // Initialize GPRT context and modules
  GPRTContext context = gprtContextCreate();
  GPRTModule module = gprtModuleCreate(context, s2_6_deviceCode);
  ...
  gprtGeomTypeSetAnyHitProg(trianglesGeomType, 0, module, "TriangleMeshAnyHit");
