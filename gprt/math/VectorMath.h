...
template<typename T, int N>
struct std::less<::math::vector<T, N>>
{
    constexpr bool operator()(const ::math::vector<T, N>& lhs, const ::math::vector<T, N>& rhs) const
    {
        for (int i = 0; i < N; ++i)
            if (lhs[i] != rhs[i])
                return lhs[i] < rhs[i];
...
template<typename T, int N>
struct std::equal_to<::math::vector<T, N>>
{
    constexpr bool operator()(const ::math::vector<T, N>& lhs, const ::math::vector<T, N>& rhs) const
    {
        for (int i = 0; i < N; ++i)
...
template<typename T, int N>
struct std::not_equal_to<::math::vector<T, N>>
{
    constexpr bool operator()(const ::math::vector<T, N>& lhs, const ::math::vector<T, N>& rhs) const
    {
        for (int i = 0; i < N; ++i)
...
template<typename T, int N>
struct std::hash<::math::vector<T, N>>
{
    constexpr int operator()(const ::math::vector<T, N>& v) const
    {
        size_t result = 0;
        for (int i = 0; i < N; ++i)
